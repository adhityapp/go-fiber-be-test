...
// @Router       /articles [get]
func (_i *locationController) Index(c *fiber.Ctx) error {
	paginate, err := paginator.Paginate(c)
	if err != nil {
		return err
	}

	var req request.LocationsRequest
	req.Pagination = paginate

	articles, paging, err := _i.locationService.All(req)
	if err != nil {
		return err
	}

	return response.Resp(c, response.Response{
		Messages: response.Messages{"Location list successfully retrieved"},
		Data:     articles,
		Meta:     paging,
	})
}
...
func (_i *locationController) Show(c *fiber.Ctx) error {
	id, err := strconv.ParseUint(c.Params("id"), 10, 64)
	if err != nil {
		return err
	}

	articles, err := _i.locationService.Show(id)
	if err != nil {
		return err
	}
...
func (_i *locationController) Store(c *fiber.Ctx) error {
	req := new(request.LocationRequest)
	...
	err := _i.locationService.Store(*req)
	if err != nil {
		return err
	}
...
func (_i *locationController) Update(c *fiber.Ctx) error {
	id, err := strconv.ParseUint(c.Params("id"), 10, 64)
	if err != nil {
		return err
	}
	...
	err = _i.locationService.Update(id, *req)
	if err != nil {
		return err
	}
...
func (_i *locationController) Delete(c *fiber.Ctx) error {
	id, err := strconv.ParseUint(c.Params("id"), 10, 64)
	if err != nil {
		return err
	}

	err = _i.locationService.Destroy(id)
	if err != nil {
		return err
	}
