...
// @Router       /articles [get]
func (_i *departmentController) Index(c *fiber.Ctx) error {
	paginate, err := paginator.Paginate(c)
	if err != nil {
		return err
	}

	var req request.DepartmentsRequest
	req.Pagination = paginate

	articles, paging, err := _i.departmentService.All(req)
	if err != nil {
		return err
	}

	return response.Resp(c, response.Response{
		Messages: response.Messages{"Department list successfully retrieved"},
		Data:     articles,
		Meta:     paging,
	})
}
...
func (_i *departmentController) Show(c *fiber.Ctx) error {
	id, err := strconv.ParseUint(c.Params("id"), 10, 64)
	if err != nil {
		return err
	}

	articles, err := _i.departmentService.Show(id)
	if err != nil {
		return err
	}
...
func (_i *departmentController) Store(c *fiber.Ctx) error {
	req := new(request.DepartmentRequest)
	...
	err := _i.departmentService.Store(*req)
	if err != nil {
		return err
	}
...
func (_i *departmentController) Update(c *fiber.Ctx) error {
	id, err := strconv.ParseUint(c.Params("id"), 10, 64)
	if err != nil {
		return err
	}
	...
	err = _i.departmentService.Update(id, *req)
	if err != nil {
		return err
	}
...
func (_i *departmentController) Delete(c *fiber.Ctx) error {
	id, err := strconv.ParseUint(c.Params("id"), 10, 64)
	if err != nil {
		return err
	}

	err = _i.departmentService.Destroy(id)
	if err != nil {
		return err
	}
